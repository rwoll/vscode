...
// Private, unlisted attachment to an existing evaluation session (no UI surface)
import './contrib/providers/remoteAgentHost/electron-browser/attachEvaluationSession.contribution.js';
