...
import { IChatBranchService, ChatBranchService } from '../common/chatBranchService.js';
...
registerSingleton(IChatBranchService, ChatBranchService, InstantiationType.Delayed);
